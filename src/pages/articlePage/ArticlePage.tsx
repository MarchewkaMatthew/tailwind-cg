...
export const ArticlePage: React.FC<ArticlePageProps> = (props) => {
  ...
  return (
    <article className="bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-50">
      ...
      <div className="container mx-auto px-8 lg:px-10 py-8 lg:flex lg:flex-wrap lg:gap-x-10 space-y-10">
        <div>
        ...
        <div className="grid grid-flow-col grid-rows-2 grid-cols-3 gap-8 h-96 lg:flex-1">
